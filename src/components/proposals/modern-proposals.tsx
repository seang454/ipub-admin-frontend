...
export function ModernProposals() {
  ...
  const papers: Paper[] = [
    ...
    },
    {
      uuid: "paper-4",
      title:
        "Neuroplasticity and Cognitive Enhancement Through Digital Therapeutics",
      abstract_text:
  ...
  const filteredPapers = papers.filter((paper) => {
    ...
    const matchesCategory =
      selectedCategory === "all" || paper.category_name === selectedCategory;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Papers awaiting review and adviser assignment
              </p>
            </div>
            ...
            >
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Badge
                    className={`${getStatusColor(paper.status)} font-medium`}
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Button size="sm">Assign Adviser</Button>
                    </div>
                  </div>
                </div>
              </CardContent>
