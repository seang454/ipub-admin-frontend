...
const HeroSection: FC = () => {
  ...
  return (
    <section className="min-h-[500px] sm:min-h-[600px] lg:min-h-[710px] bg-card px-4 sm:px-6 md:px-10 lg:px-16 py-6 sm:py-8 md:py-12 flex flex-col lg:flex-row items-center justify-between">
      ...
      {/* Left Content */}
      <div className="mt-6 sm:mt-10 max-w-xl lg:max-w-md mx-auto lg:mx-0 lg:ml-4 xl:ml-20 text-center lg:text-left">
        <h1 className="text-hero-subtitle mb-3 sm:mb-4 md:mb-6 text-xl sm:text-2xl md:text-3xl lg:text-4xl leading-tight">
          {t("hero_title", {
            defaultValue:
        ...
        <p className="mb-3 sm:mb-4 md:mb-6 text-foreground text-sm sm:text-base md:text-lg">
        ...
        <p className="italic text-foreground text-sm sm:text-base md:text-lg flex flex-col sm:flex-row items-center justify-center lg:justify-start">
          {t("hero_quote", {
            defaultValue: "Knowledge grows when it's shared.",
          })}{" "}
          <span
            className="text-orange-500 text-lg sm:text-xl md:text-2xl align-middle mt-2 sm:mt-0 sm:ml-2"
            aria-label="quote"
          >
            <svg
              ...
              height="36"
              viewBox="0 0 16 16"
              className="-scale-x-100 text-accent dark:text-accent sm:w-10 sm:h-10 md:w-12 md:h-12"
            >
              <path
                fill="currentColor"
      ...
      <div className="relative mt-6 sm:mt-8 lg:mt-0 flex-shrink-0 w-64 sm:w-80 md:w-96 lg:w-[480px] h-64 sm:h-80 md:h-96 lg:h-[480px] flex justify-center items-center">
        ...
        <div className="absolute top-4 sm:top-8 md:top-12 -right-8 sm:-right-12 md:-right-14 lg:-right-16 bg-blue-500 rounded-lg px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 max-w-[140px] sm:max-w-xs shadow-lg z-20">
          <div className="w-5 sm:w-6 md:w-8 lg:w-10 h-5 sm:h-6 md:h-8 lg:h-10 rounded-full overflow-hidden flex-shrink-0">
            <Image
              ...
              width={40}
              height={40}
              className="object-cover scale-160 w-full h-full"
            />
          </div>
          <div className="text-white min-w-0 flex-1">
            <p className="font-bold text-xs sm:text-sm md:text-base lg:text-lg">
        ...
        {/* Document Icon */}
        <svg
          className="absolute top-2 sm:top-6 md:top-10 left-1 sm:left-2 md:left-2 w-5 sm:w-6 md:w-8 h-5 sm:h-6 md:h-8 stroke-blue-600 z-0"
          fill="none"
          strokeWidth="2"
          strokeLinecap="round"
        ...
        {/* Graduation cap icon */}
        <svg
          className="absolute top-6 sm:top-12 md:top-16 right-2 sm:right-6 md:right-10 lg:right-20 w-5 sm:w-6 md:w-8 h-5 sm:h-6 md:h-8 stroke-blue-600 z-0"
          fill="none"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        {/* Book icon */}
        <svg
          className="absolute bottom-2 sm:bottom-8 md:bottom-12 left-1 sm:left-2 md:left-2 w-5 sm:w-7 md:w-10 h-5 sm:h-7 md:h-10 stroke-blue-600 z-0"
          fill="none"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        {/* WhatsApp icon */}
        <svg
          className="absolute bottom-2 sm:bottom-4 md:bottom-6 right-2 sm:right-4 md:right-6 w-5 sm:w-6 md:w-8 h-5 sm:h-6 md:h-8 fill-blue-600 cursor-pointer z-0"
          viewBox="0 0 24 24"
        >
